...
public class TVShowsAiringTodayResponse {
    ...
    public TVShowsAiringTodayResponse(List<TVShowBrief> results, Integer page, Integer totalResults, Integer totalPages) {
